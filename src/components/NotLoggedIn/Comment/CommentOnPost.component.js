...
import './CommentOnPostStyles.css';
...
export default class CommentOnPost extends Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount() {
        ...
        axios.post('http://localhost:5000/get_post_comments', formInfo)
            .then(response => {
    ...
    submitComment(e) {
        ...
        fileData.append("postId", this.props.postId);

        axios.post('http://localhost:5000/comment_on_post', fileData, {
            headers: {
